...
const Navbar = () => {
  ...
  return (
    <div className='flex justify-between items-center h-24 max-w-[1150px] mx-auto px-8 text-white md:border-b-2 border-gray-600 border-b-2'> 
        ...
        <h1 className='w-full text-3xl font-bold text-[#00df9a] m-4 pt-1 pl-3'>React.</h1>
